...
Interface principal que combina todas as funcionalidades.
...
Envia requests (commands/queries) para handlers.
...
Publica notificações para múltiplos handlers.
...
Envia requests que retornam streams assíncronos.
...
Struct para representar ausência de valor.
