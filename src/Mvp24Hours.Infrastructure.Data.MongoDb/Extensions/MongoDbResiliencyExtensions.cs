...
public static class MongoDbResiliencyExtensions
{
        ...
        Action<MongoDbResiliencyOptions> configure)
    {
        ...
        // Intentional compat shim: registers the obsolete MongoDbResiliencyPolicy for
        // IMongoDbResiliencyPolicy consumers. Prefer AddNativeMongoDbResilience (§1.B / task 7.1).
...
#pragma warning restore CS0618
    ...
    {
        services.PostConfigure<MongoDbResiliencyOptions>(options => options.AdditionalRetryableExceptions.AddRange(exceptionTypes));
    ...
    public static IServiceCollection AddNonRetryableExceptions(
        ...
        params Type[] exceptionTypes)
    {
        services.PostConfigure<MongoDbResiliencyOptions>(options => options.NonRetryableExceptions.AddRange(exceptionTypes));
