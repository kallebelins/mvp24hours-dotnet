...
public class MongoDbTextSearchService<TDocument>(
    IMongoCollection<TDocument> collection,
    ILogger<MongoDbTextSearchService<TDocument>>? logger = null) : IMongoDbTextSearchService<TDocument>
{
    private readonly IMongoCollection<TDocument> _collection = collection ?? throw new ArgumentNullException(nameof(collection));
    private readonly ILogger<MongoDbTextSearchService<TDocument>>? _logger = logger;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string searchText = string.Join(" ", searchParts);
