...
public class ShardKeyField
{
    ...
    public static ShardKeyField Ascending(string fieldName)
    {
        return new() { FieldName = fieldName, Order = 1 };
    }
    ...
    /// </summary>
    /// <param name="fieldName">The field name.</param>
    public static ShardKeyField Descending(string fieldName)
    {
        return new() { FieldName = fieldName, Order = -1 };
    }
    ...
    /// </summary>
    /// <param name="fieldName">The field name.</param>
    public static ShardKeyField Hashed(string fieldName)
    {
        return new() { FieldName = fieldName, Order = "hashed" };
    }
}
