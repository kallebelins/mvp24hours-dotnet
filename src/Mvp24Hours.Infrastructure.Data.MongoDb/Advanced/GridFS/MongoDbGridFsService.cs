...
public class MongoDbGridFsService : IMongoDbGridFsService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        ObjectId id = await Bucket.UploadFromStreamAsync(filename, stream, options, cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        ObjectId id = await Bucket.UploadFromBytesAsync(filename, bytes, options, cancellationToken);
    ...
    public async Task DownloadAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        await Bucket.DownloadToStreamAsync(id, destination, options, cancellationToken);
    ...
    public async Task DownloadByNameAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        await Bucket.DownloadToStreamByNameAsync(filename, destination, options, cancellationToken);
    ...
    public async Task<byte[]> DownloadAsBytesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        byte[] bytes = await Bucket.DownloadAsBytesAsync(id, options, cancellationToken);
    ...
    public async Task<Stream> OpenDownloadStreamAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await Bucket.OpenDownloadStreamAsync(id, options, cancellationToken);
    }
    ...
    public async Task<GridFSFileInfo> GetFileInfoAsync(ObjectId id, CancellationToken cancellationToken = default)
    {
        ...
        IAsyncCursor<GridFSFileInfo> cursor = await Bucket.FindAsync(filter, cancellationToken: cancellationToken);
    ...
    public async Task<GridFSFileInfo> GetFileInfoByNameAsync(string filename, CancellationToken cancellationToken = default)
    {
        ...
        IAsyncCursor<GridFSFileInfo> cursor = await Bucket.FindAsync(filter, options, cancellationToken);
        return await cursor.FirstOrDefaultAsync(cancellationToken);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IAsyncCursor<GridFSFileInfo> cursor = await Bucket.FindAsync(filterDefinition, findOptions, cancellationToken);
    ...
    {
        await Bucket.RenameAsync(id, newFilename, cancellationToken);
    ...
    {
        await Bucket.DropAsync(cancellationToken);
