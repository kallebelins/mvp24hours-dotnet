...
public class MongoDbGeospatialService<TDocument>(
    IMongoCollection<TDocument> collection,
    ILogger<MongoDbGeospatialService<TDocument>>? logger = null) : IMongoDbGeospatialService<TDocument>
{
    private readonly IMongoCollection<TDocument> _collection = collection ?? throw new ArgumentNullException(nameof(collection));
    private readonly ILogger<MongoDbGeospatialService<TDocument>>? _logger = logger;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string indexName = await _collection.Indexes.CreateOneAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string indexName = await _collection.Indexes.CreateOneAsync(indexModel, cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            double distance = result["distance"].AsDouble;
