...
public class GeoPoint
{
    ...
    public double DistanceTo(GeoPoint other)
    {
        ...
        double deltaLng = ToRadians(other.Longitude - Longitude);
...
public class GeoPolygon
{
    ...
    public static GeoPolygon FromPoints(params GeoPoint[] points)
    {
        ...
        double[][] ring = new double[points.Length][];
    ...
    public static GeoPolygon CreateCircle(GeoPoint center, double radiusMeters, int segments = 32)
    {
        ...
        double angularDistance = radiusMeters / EarthRadiusMeters;
    ...
    public BsonDocument ToBsonDocument()
    {
        ...
        foreach (double[][] ring in Coordinates)
        {
