...
{
    /// <summary>
    /// Unit of Work implementation with automatic Domain Event dispatching (asynchronous version).
    /// Extends <see cref="UnitOfWorkAsync"/> functionality to automatically collect and dispatch
    ...
    public class UnitOfWorkWithEventsAsync : IUnitOfWorkWithEventsAsync
    {
        ...
        /// <summary>
        /// Creates a new instance with just the database context.
        /// </summary>
        /// <param name="dbContext">The MongoDB context.</param>
        /// <param name="eventDispatcher">Optional domain event dispatcher.</param>
        /// <param name="logger">Optional logger.</param>
