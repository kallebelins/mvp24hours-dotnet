...
public readonly struct DeleteInterceptionResult
{
    ...
    /// </summary>
    public static DeleteInterceptionResult Proceed()
    {
    ...
    /// </summary>
    public static DeleteInterceptionResult SoftDelete()
    {
    ...
    /// </summary>
    public static DeleteInterceptionResult SuppressOperation()
    {
