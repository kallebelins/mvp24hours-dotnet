...
public class CommandLogger : MongoDbInterceptorBase
{
    ...
    {
        string operationType = wasSoftDeleted ? "SoftDelete" : "Delete";
    ...
    {
        string key = entity.EntityKey?.ToString() ?? Guid.NewGuid().ToString();
    ...
    {
        bool isSlowOperation = duration >= _slowOperationThreshold;
