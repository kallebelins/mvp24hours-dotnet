...
public static class CronJobConfigurationExtensions
{
        ...
        where T : CronJobService<T>
    {
        ...
        string sectionPath = CronJobOptions<T>.GetSectionPath();
        ...
        return services.AddCronJobWithOptions<T>(options => section.Bind(options), configuration);
    }
        ...
        where T : ResilientCronJobService<T>
    {
        ...
        return services.AddResilientCronJobWithOptions<T>(options => section.Bind(options), configuration);
    }
        ...
        where T : AdvancedCronJobService<T>
    {
        ...
        return services.AddAdvancedCronJobWithOptions<T>(options => section.Bind(options), configuration);
    }
        ...
        where T : CronJobService<T>
    {
        ...
        {
            string instanceName = config.GetEffectiveInstanceName();
