...
public sealed class CronJobDependency(
    string dependentJobName,
    IReadOnlyList<string> requiredJobNames,
    bool requireSuccess = true,
    TimeSpan? maxAge = null) : ICronJobDependency
{

    /// <inheritdoc />
    public string DependentJobName { get; } = dependentJobName ?? throw new ArgumentNullException(nameof(dependentJobName));

    /// <inheritdoc />
    public IReadOnlyList<string> RequiredJobNames { get; } = requiredJobNames ?? throw new ArgumentNullException(nameof(requiredJobNames));

    /// <inheritdoc />
    public bool RequireSuccess { get; } = requireSuccess;
