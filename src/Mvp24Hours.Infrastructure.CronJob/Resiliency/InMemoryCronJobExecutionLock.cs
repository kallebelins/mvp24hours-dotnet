...
/// </param>
public class InMemoryCronJobExecutionLock(TimeProvider? timeProvider = null) : ICronJobExecutionLock
{
    ...
    private sealed class InMemoryLockHandle(
        ...
        string jobName,
        DateTimeOffset acquiredAt) : ICronJobLockHandle
    {
        private readonly InMemoryCronJobExecutionLock _parent = parent;
