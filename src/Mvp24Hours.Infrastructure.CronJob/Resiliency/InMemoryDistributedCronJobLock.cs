...
public sealed class InMemoryDistributedCronJobLock(TimeProvider? timeProvider = null) : IDistributedCronJobLock
{
    ...
    private sealed class InMemoryDistributedCronJobLockHandle(
        InMemoryDistributedCronJobLock parent,
InMemoryDistributedCronJobLock.LockEntry entry,
        TimeProvider timeProvider) : IDistributedCronJobLockHandle
    {
        private readonly InMemoryDistributedCronJobLock _parent = parent;
