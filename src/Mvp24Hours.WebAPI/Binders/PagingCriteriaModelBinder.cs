...
public class PagingCriteriaModelBinder : IModelBinder
{
    ...
    public Task BindModelAsync(ModelBindingContext bindingContext)
    {
        ...
        string? limitValue = GetValue(valueProvider, modelName, "limit") ?? GetValue(valueProvider, modelName, "pageSize");
        string? offsetValue = GetValue(valueProvider, modelName, "offset") ?? GetValue(valueProvider, modelName, "page");
        string? orderByValue = GetValue(valueProvider, modelName, "orderBy");
        string? navigationValue = GetValue(valueProvider, modelName, "navigation");
    ...
    {
        string fullName = string.IsNullOrEmpty(modelName) ? propertyName : $"{modelName}.{propertyName}";
