...
public class IdempotencyKeyResult
{
    ...
    /// </summary>
    public static IdempotencyKeyResult NoKey()
    {
        return new();
    }
    ...
    /// </summary>
    public static IdempotencyKeyResult FromHeader(string key)
    {
        return new()
        {
            Key = key,
    ...
    /// </summary>
    public static IdempotencyKeyResult Generated(string key, string requestBodyHash)
    {
        return new()
        {
            Key = key,
