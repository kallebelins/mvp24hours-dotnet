...
public static class NativeOpenApiServiceExtensions
{
        ...
        Action<NativeOpenApiOptions>? configureOptions = null)
    {
        ...
        services.AddOpenApi(options.DocumentName, openApiOptions => ConfigureOpenApiDocument(openApiOptions, options));
        ...
        foreach (OpenApiVersionConfig version in options.AdditionalVersions)
        {
            ...
            services.AddOpenApi(version.DocumentName, openApiOptions =>
            {
                ...
                if (version.IsDeprecated)
                {
                    ...
                    {
                        string deprecationNote = version.DeprecationMessage ?? "This API version is deprecated.";
