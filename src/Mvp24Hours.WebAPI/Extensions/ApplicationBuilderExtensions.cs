...
public static class ApplicationBuilderExtensions
{
        ...
        string swaggerRoutePrefix = "swagger")
    {
        ...
        builder.UseSwaggerUI(options =>
        {
            ...
            {
                string versionInfo = description.IsDeprecated
        ...
        string reDocRoutePrefix = "redoc")
    {
        ...
        if (apiVersionDescriptionProvider != null)
        {
            ...
            {
                string specUrl = $"/swagger/{latestVersion.GroupName}/swagger.json";

                // Map ReDoc route to serve HTML
                builder.Map($"/{reDocRoutePrefix}", appBuilder => appBuilder.Run(async context =>
                    {
                        string html = $@"
<!DOCTYPE html>
<html>
    ...
    public static IApplicationBuilder UseMvp24HoursHealthChecks(this IApplicationBuilder builder)
    {
        ...
        var healthCheckOptions = new Microsoft.AspNetCore.Diagnostics.HealthChecks.HealthCheckOptions
        {
            ...
            ResponseWriter = async (context, result) =>
            {
                ...
                string json = System.Text.Json.JsonSerializer.Serialize(response, new System.Text.Json.JsonSerializerOptions
                {
                    WriteIndented = true
                });
        ...
        if (builder is Microsoft.AspNetCore.Routing.IEndpointRouteBuilder endpointRouteBuilder)
        {
