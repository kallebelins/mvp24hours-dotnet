...
public class VersionedSwaggerDocumentFilter(SwaggerOptions options) : IDocumentFilter
{
    private readonly SwaggerOptions _options = options ?? throw new ArgumentNullException(nameof(options));
