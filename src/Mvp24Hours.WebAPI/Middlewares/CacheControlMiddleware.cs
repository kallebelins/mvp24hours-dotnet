    ...
    ILogger<CacheControlMiddleware> logger)
{
    ...
    private readonly CacheControlOptions _options = options?.Value ?? throw new ArgumentNullException(nameof(options));
    private readonly ILogger<CacheControlMiddleware> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        {
            string cacheControl = BuildCacheControlHeader(policy);
