...
public class XmlContentFormatter : IContentFormatter, IProblemDetailsFormatter
{
    ...
    public async Task SerializeAsync(Stream stream, object? value, Encoding encoding, CancellationToken cancellationToken = default)
    {
        if (value == null)
        {
            byte[] nullXml = encoding.GetBytes("<?xml version=\"1.0\" encoding=\"utf-8\"?><null />");
    ...
    {
        string mediaType = _options.UseRfc7807ContentTypeForProblemDetails
            ? "application/problem+xml"
            : "application/xml";
    ...
    private static bool IsSerializable(Type type)
    {
        ...
        bool hasDataContract = type.GetCustomAttributes(typeof(DataContractAttribute), true).Length > 0;
