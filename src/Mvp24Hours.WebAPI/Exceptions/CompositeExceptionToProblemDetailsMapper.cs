...
public class CompositeExceptionToProblemDetailsMapper(
    IEnumerable<IExceptionToProblemDetailsMapper> mappers,
    DefaultExceptionToProblemDetailsMapper defaultMapper) : IExceptionToProblemDetailsMapper
{
    private readonly IEnumerable<IExceptionToProblemDetailsMapper> _mappers = mappers ?? throw new ArgumentNullException(nameof(mappers));
    private readonly IExceptionToProblemDetailsMapper _defaultMapper = defaultMapper ?? throw new ArgumentNullException(nameof(defaultMapper));
