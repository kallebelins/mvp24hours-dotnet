...
public sealed class SortCriteria
{
    ...
    {
        return new() { PropertyName = propertyName, Direction = SortDirection.Ascending };
    }
    ...
    {
        return new() { PropertyName = propertyName, Direction = SortDirection.Descending };
    }
}
    ...
    where TEntity : class
{
    ...
    {
        return new() { PropertySelector = propertySelector, Direction = SortDirection.Ascending };
    }
    ...
    {
        return new() { PropertySelector = propertySelector, Direction = SortDirection.Descending };
    }
}
