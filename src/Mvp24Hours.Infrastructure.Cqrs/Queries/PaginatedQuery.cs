    ...
    where TEntity : class
{
    ...
    /// </summary>
    public IList<Expression<Func<TEntity, dynamic>>> OrderByAscendingExpr => field ??= [];

    /// <summary>
    /// Gets the descending order expressions.
    /// </summary>
    public IList<Expression<Func<TEntity, dynamic>>> OrderByDescendingExpr => field ??= [];

    /// <summary>
    /// Gets the navigation expressions for eager loading.
    /// </summary>
    public IList<Expression<Func<TEntity, dynamic>>> NavigationExpr => field ??= [];
