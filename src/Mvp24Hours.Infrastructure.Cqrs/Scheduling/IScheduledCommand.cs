...
public class ScheduleOptions
{
    ...
    /// </summary>
    public static ScheduleOptions Now()
    {
        return new() { ScheduledAt = DateTime.UtcNow };
    }
    ...
    public static ScheduleOptions After(TimeSpan delay)
    {
        return new() { ScheduledAt = DateTime.UtcNow.Add(delay) };
    }
    ...
    public static ScheduleOptions At(DateTime scheduledAt)
    {
