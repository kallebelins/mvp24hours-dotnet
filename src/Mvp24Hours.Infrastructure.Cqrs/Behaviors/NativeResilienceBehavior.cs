...
public class NativeResilienceBehavior<TRequest, TResponse>(
    NativeCqrsResilienceOptions options,
    ILogger<NativeResilienceBehavior<TRequest, TResponse>>? logger = null) : IPipelineBehavior<TRequest, TResponse>
    where TRequest : IMediatorRequest<TResponse>
{
    private readonly NativeCqrsResilienceOptions _defaultOptions = options ?? new NativeCqrsResilienceOptions();
    private readonly ILogger<NativeResilienceBehavior<TRequest, TResponse>>? _logger = logger;
