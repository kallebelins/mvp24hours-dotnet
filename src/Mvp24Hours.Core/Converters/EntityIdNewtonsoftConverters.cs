...
public class EntityIdNewtonsoftConverter : JsonConverter
{
    ...
    public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
    {
        ...
        else if (IsIntEntityId(objectType))
        {
            ...
            if (reader.TokenType == JsonToken.String && int.TryParse(reader.Value?.ToString(), out int intValue))
            {
        ...
        else if (IsLongEntityId(objectType))
        {
            ...
            if (reader.TokenType == JsonToken.String && long.TryParse(reader.Value?.ToString(), out long longValue))
            {
    ...
    public override void WriteJson(JsonWriter writer, object? value, JsonSerializer serializer)
    {
        ...
        object? underlyingValue = valueProperty?.GetValue(value);
