...
public sealed class TestClock : IClock
{
    ...
    /// <inheritdoc />
    public DateTime Today => TimeZoneInfo.ConvertTimeFromUtc(UtcNow, _timeZone).Date;
    ...
    {
        UtcNow = DateTime.SpecifyKind(utcTime, DateTimeKind.Utc);
    }
    ...
    {
        UtcNow = UtcNow.Subtract(duration);
    }
    ...
    {
        AdvanceBy(TimeSpan.FromSeconds(seconds));
    }
    ...
    {
        AdvanceBy(TimeSpan.FromMinutes(minutes));
    }
    ...
    {
        AdvanceBy(TimeSpan.FromHours(hours));
    }
    ...
    {
        AdvanceBy(TimeSpan.FromDays(days));
    }
