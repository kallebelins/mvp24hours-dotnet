...
public sealed class SequentialGuidGenerator(SequentialGuidType type = SequentialGuidType.SqlServer) : IGuidGenerator
{
    private static readonly object _lock = new();
    private readonly SequentialGuidType _type = type;
