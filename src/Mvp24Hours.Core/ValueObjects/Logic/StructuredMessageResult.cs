...
public class StructuredMessageResult(
    string key,
    string message,
    string errorCode,
    ...
    int? httpStatusCode = null) : BaseVO, IStructuredMessageResult
{
    ...
    /// <inheritdoc />
    [DataMember]
    public string ErrorCode { get; } = errorCode ?? "UNKNOWN_ERROR";
    ...
    /// <inheritdoc />
    [DataMember]
    public int? HttpStatusCode { get; } = httpStatusCode ?? GetDefaultHttpStatusCode(category);
