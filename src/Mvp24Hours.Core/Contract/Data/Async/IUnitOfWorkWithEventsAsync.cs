...
{
    /// <summary>
    /// Async version of <see cref="IUnitOfWorkWithEvents"/>.
    /// Extends <see cref="IUnitOfWorkAsync"/> with Domain Event support.
    /// Automatically dispatches domain events after successfully persisting changes.
    /// </summary>
    /// <remarks>
    /// <para>
    /// <strong>Design Pattern: Unit of Work with Domain Events (Async)</strong>
    /// </para>
    /// <para>
    ...
    /// <item><description>Full async/await support for non-blocking operations</description></item>
    /// </list>
    /// <para>
    ...
    /// <item><description>Changes are persisted to the database asynchronously</description></item>
    ...
    /// <example>
    /// <code>
    /// // Using IUnitOfWorkWithEventsAsync
    ...
    /// </code>
    /// </example>
    public interface IUnitOfWorkWithEventsAsync : IUnitOfWorkAsync
    {
        /// <summary>
        /// Persists all changes and dispatches domain events from tracked entities asynchronously.
        /// </summary>
        ...
        /// <item><description>Dispatches collected domain events asynchronously</description></item>
        ...
        /// int changes = await unitOfWork.SaveChangesWithEventsAsync();
        /// </code>
        /// </example>
        ...
        /// before calling <see cref="SaveChangesWithEventsAsync"/>.
        /// </para>
        /// </remarks>
        /// <example>
        /// <code>
