...
public sealed class BulkOperationResult
{
    ...
    {
        return new() { RowsAffected = rowsAffected, ElapsedTime = elapsedTime, IsSuccess = true };
    }
    ...
    {
        return new() { IsSuccess = false, ErrorMessage = errorMessage, ElapsedTime = elapsedTime };
    }
}
