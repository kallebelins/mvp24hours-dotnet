...
namespace Mvp24Hours.Core.Contract.Infrastructure.Pipe
{
    ...
    public interface IPipeline
    {
        ...
        /// </summary>
        IPipeline AddInterceptors(MvpEventHandler<IPipelineMessage, EventArgs> handler, PipelineInterceptorType pipelineInterceptor = PipelineInterceptorType.PostOperation);
        /// <summary>
        /// Records event operations interceptors
        /// </summary>
        IPipeline AddInterceptors(MvpEventHandler<IPipelineMessage, EventArgs> handler, Func<IPipelineMessage, bool> condition, bool postOperation = true);
        /// <summary>
        /// Performs operations 
        /// </summary>
