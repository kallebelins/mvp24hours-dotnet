    ...
    ILogger<RowLevelSecurityHelper>? logger = null)
{
    ...
    private readonly string _defaultSessionContextKey = sessionContextKey;
    private readonly ILogger<RowLevelSecurityHelper>? _logger = logger;
        ...
        string tenantIdColumn = "TenantId")
    {
        ...
        string functionName = $"fn_tenant_predicate_{tableName}";
        ...
        string policyName = $"TenantPolicy_{tableName}";
    ...
    public void SetSqlServerTenantContext(DbContext context, string tenantId)
    {
        ...
        string sql = $"EXEC sp_set_session_context @key=N'{_defaultSessionContextKey}', @value=@tenantId";
    ...
    {
        var sb = new StringBuilder();
        string policyName = $"tenant_isolation_policy";
        ...
        string? schema = null)
    {
        ...
        foreach (IMutableEntityType entityType in modelBuilder.Model.GetEntityTypes())
        {
            if (typeof(ITenantEntity).IsAssignableFrom(entityType.ClrType))
            {
                ...
                string entitySchema = entityType.GetSchema() ?? schema;

                string script = databaseType switch
                {
