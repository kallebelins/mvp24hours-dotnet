...
public static class QueryTimeoutExtensions
{
    ...
    public static async Task<T> WithTimeoutAsync<T>(
        ...
        Func<Task<T>> action)
    {
        int? originalTimeout = context.Database.GetCommandTimeout();
        try
        {
    ...
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await query.ToListAsync(cancellationToken));
    }
    ...
    public static async Task<T?> FirstOrDefaultWithTimeoutAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await query.FirstOrDefaultAsync(cancellationToken));
    }
    ...
    public static async Task<int> CountWithTimeoutAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await query.CountAsync(cancellationToken));
    }
    ...
    public static async Task<bool> AnyWithTimeoutAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await query.AnyAsync(cancellationToken));
    }
    ...
    public static async Task<int> SaveChangesWithTimeoutAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await context.SaveChangesAsync(cancellationToken));
    }
    ...
    public static async Task<int> ExecuteUpdateWithTimeoutAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await query.ExecuteUpdateAsync(setPropertyCalls, cancellationToken));
    }
    ...
    public static async Task<int> ExecuteDeleteWithTimeoutAsync<T>(
        ...
        CancellationToken cancellationToken = default)
    {
        return await context.WithTimeoutAsync(timeoutSeconds, async () => await query.ExecuteDeleteAsync(cancellationToken));
    }
