...
public sealed class DbContextHealthCheckOptions
{
    ...
    /// </summary>
    public IEnumerable<string> Tags { get; set; } = ["db", "database", "efcore"];
    ...
    /// </summary>
    public static DbContextHealthCheckOptions SqlServer()
    {
        return new()
        {
            ...
            Tags = ["db", "database", "efcore", "sqlserver"]
        };
    }
    ...
    /// </summary>
    public static DbContextHealthCheckOptions PostgreSql()
    {
        return new()
        {
            HealthQuery = "SELECT 1",
            ...
            DegradedThresholdMs = 500,
            FailureThresholdMs = 2000,
            Tags = ["db", "database", "efcore", "postgresql"]
        };
    }
    ...
    /// </summary>
    public static DbContextHealthCheckOptions MySql()
    {
        return new()
        {
            HealthQuery = "SELECT 1",
    ...
    /// </summary>
    public static DbContextHealthCheckOptions Strict()
    {
        return new()
        {
            HealthQuery = "SELECT 1",
    ...
    /// </summary>
    public static DbContextHealthCheckOptions Liveness()
    {
        return new()
        {
