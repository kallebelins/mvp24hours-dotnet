...
public sealed class EFCoreResilienceOptions
{
    ...
    {
        return ReadCommandTimeoutSeconds ?? CommandTimeoutSeconds;
    }
    ...
    {
        return WriteCommandTimeoutSeconds ?? CommandTimeoutSeconds;
    }

    /// <summary>
    /// Creates default options optimized for production workloads.
    /// </summary>
    public static EFCoreResilienceOptions Production()
    {
        return new()
        {
    ...
    /// </summary>
    public static EFCoreResilienceOptions Development()
    {
        return new()
        {
            EnableRetryOnFailure = true,
    ...
    /// </summary>
    public static EFCoreResilienceOptions AzureSql()
    {
        return new()
        {
            EnableRetryOnFailure = true,
    ...
    /// </summary>
    public static EFCoreResilienceOptions NoResilience()
    {
        return new()
        {
