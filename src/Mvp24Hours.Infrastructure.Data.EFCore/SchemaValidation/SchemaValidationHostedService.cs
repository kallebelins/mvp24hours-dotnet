...
/// </remarks>
public class SchemaValidationHostedService<TContext>(
    IServiceProvider serviceProvider,
    IOptions<SchemaValidationOptions> options,
    ILogger<SchemaValidationHostedService<TContext>> logger) : IHostedService
    where TContext : Microsoft.EntityFrameworkCore.DbContext
{
    ...
    private readonly ILogger<SchemaValidationHostedService<TContext>> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
