...
public sealed class ReadWriteOptions
{
    ...
    /// </summary>
    public static ReadWriteOptions SimpleSetup(string primaryConnectionString, string replicaConnectionString)
    {
        return new()
        {
    ...
    /// </summary>
    public static ReadWriteOptions AzureSqlGeoReplica(string primaryConnectionString, params string[] replicaConnectionStrings)
    {
        return new()
        {
            PrimaryConnectionString = primaryConnectionString,
            ReplicaConnectionStrings = [.. replicaConnectionStrings],
    ...
    /// </summary>
    public static ReadWriteOptions PostgreSqlStreaming(string primaryConnectionString, params string[] replicaConnectionStrings)
    {
        return new()
        {
            PrimaryConnectionString = primaryConnectionString,
