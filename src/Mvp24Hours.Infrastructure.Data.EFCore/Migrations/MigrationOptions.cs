...
public sealed class MigrationOptions
{
    ...
    /// </summary>
    public static MigrationOptions Development()
    {
        return new()
        {
    ...
    /// </summary>
    public static MigrationOptions Staging()
    {
        return new()
        {
            AutoMigrateOnStartup = true,
    ...
    /// </summary>
    public static MigrationOptions Production()
    {
        return new()
        {
    ...
    /// </summary>
    public static MigrationOptions LogOnly()
    {
        return new()
        {
