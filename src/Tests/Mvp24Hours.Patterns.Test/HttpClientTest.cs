...
public class HttpClientTest
{
    ...
    public async Task GetPostsAsyncByNameClass()
    {
        ...
        string? result = await client.HttpGetAsync("users");
        // assert
    ...
    public async Task GetPostsWithNotFoundAsync()
    {
        await Assert.ThrowsAsync<HttpStatusCodeException>(async () =>
        {
            ...
            IHttpClientFactory? factory = serviceProvider.GetRequiredService<IHttpClientFactory>();
            HttpClient client = factory.CreateClient("jsonUrl");
            string? result = await client.HttpGetAsync("notFound");
            // assert
            Assert.NotNull(result);
        });
    }
    ...
    public async Task GetIdPostsAsync()
    {
        ...
        IHttpClientFactory? factory = serviceProvider.GetRequiredService<IHttpClientFactory>();
        HttpClient client = factory.CreateClient("jsonUrl");
        string? result = await client.HttpGetAsync("posts/1");
        // assert
        Assert.NotNull(result);
    }
    ...
    public async Task PostPostsAsync()
    {
        ...
        IHttpClientFactory? factory = serviceProvider.GetRequiredService<IHttpClientFactory>();
        HttpClient client = factory.CreateClient("jsonUrl");
        string? result = await client.HttpPostAsync("posts", dto.ToSerialize());
        // assert
        Assert.NotNull(result);
    }
    ...
    public async Task PutPostsAsync()
    {
        ...
        IHttpClientFactory? factory = serviceProvider.GetRequiredService<IHttpClientFactory>();
        HttpClient client = factory.CreateClient("jsonUrl");
        string? result = await client.HttpPutAsync("posts/1", dto.ToSerialize());
        // assert
        Assert.NotNull(result);
    }
    ...
    public async Task DeletePostsAsync()
    {
        ...
        IHttpClientFactory? factory = serviceProvider.GetRequiredService<IHttpClientFactory>();
        HttpClient client = factory.CreateClient("jsonUrl");
        string? result = await client.HttpDeleteAsync("posts/1");
        // assert
        Assert.Equal("{}", result);
    }
    ...
    public async Task PatchPostsAsync()
    {
        ...
        IHttpClientFactory? factory = serviceProvider.GetRequiredService<IHttpClientFactory>();
        HttpClient client = factory.CreateClient("jsonUrl");
        string? result = await client.HttpPatchAsync("posts/1", dto.ToSerialize());
        // assert
        Assert.NotNull(result);
    }
}
