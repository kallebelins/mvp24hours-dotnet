...
public class FluentValidationOperationTest
{
    ...
    public async Task FluentValidationOperation_ReturnsSuccess_WhenValid()
    {
        ...
        var operation = new FluentValidationOperation<TestOrder>([validator]);
    ...
    {
        // Arrange
        var operation = new FluentValidationOperation<TestOrder>([]);
    ...
    public async Task FluentValidationOperation_ThrowsException_WhenConfigured()
    {
        ...
        var operation = new FluentValidationOperation<TestOrder>([validator], options: options);
    ...
    public async Task FluentValidationOperation_MultipleValidators_AllRun()
    {
        ...
        var operation = new FluentValidationOperation<TestOrder>([validator1, validator2]);
