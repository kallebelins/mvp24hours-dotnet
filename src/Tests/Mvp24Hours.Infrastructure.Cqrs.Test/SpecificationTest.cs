...
[Trait("Category", "Unit")]
public class ExpensiveProductSpec(decimal minPrice = 100m) : Specification<Product>
{
...
[Trait("Category", "Unit")]
public class CategoryProductSpec(string category) : Specification<Product>
{
...
[Trait("Category", "Unit")]
public class GetProductsQuery(int page, int pageSize) : PaginatedQuery<Product, IEnumerable<Product>>(page, pageSize)
{
...
public class SpecificationTest
{
    ...
    public void Specification_IsSatisfiedBy_ActiveProduct_ReturnsTrue()
    {
        ...
        // Act
        bool result = spec.IsSatisfiedBy(product);
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type - testing null behavior
        bool result = spec.IsSatisfiedBy(null);
#pragma warning restore CS8625
    ...
    public void SortedQuery_ClearSort_Works()
    {
        // Arrange
        var query = new GetActiveProductsQuery();
        int initialExprCount = query.SortExpressions.Count;
