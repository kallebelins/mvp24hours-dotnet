...
public class ResultMessageTest
{
    ...
    {
        var message = ResultMessage.Error("Invalid value", "VALIDATION.INVALID", "Amount", 0);
    ...
    {
        var message = ResultMessage.Warning("Low stock", "INVENTORY.LOW", "Quantity");
    ...
    {
        var message = ResultMessage.Info("Additional detail", "INFO.DETAIL");
    ...
    {
        var message = ResultMessage.Error("Bad", "ERR.BAD", "Field");
    ...
    {
        var left = ResultMessage.Error("Same", "CODE", "Prop");
        var right = ResultMessage.Error("Same", "CODE", "Prop");
