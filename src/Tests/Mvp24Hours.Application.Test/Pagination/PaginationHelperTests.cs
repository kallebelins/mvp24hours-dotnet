...
public class PaginationHelperTests
{
    ...
    {
        // Act
        int result = PaginationHelper.CalculateTotalPages(totalCount, pageSize);
    ...
    {
        // Act
        int result = PaginationHelper.CalculateOffset(page, pageSize);
    ...
    {
        // Act
        int result = PaginationHelper.CalculateOffset(0, 10);
    ...
    {
        // Act
        int result = PaginationHelper.OffsetToPage(offset, limit);
    ...
    {
        // Act
        int result = PaginationHelper.OffsetToPage(50, 0);
    ...
    {
        // Act
        int result = PaginationHelper.NormalizePage(page, totalPages);
    ...
    {
        // Act
        int result = PaginationHelper.NormalizePage(5, 0);
    ...
    {
        // Act
        int result = PaginationHelper.NormalizePageSize(pageSize, maxPageSize);
    ...
    {
        // Act
        int result = PaginationHelper.GetStartIndex(page, pageSize, totalCount);
    ...
    {
        // Act
        int result = PaginationHelper.GetStartIndex(1, 10, 0);
    ...
    {
        // Act
        int result = PaginationHelper.GetEndIndex(page, pageSize, totalCount);
    ...
    {
        // Act
        string result = PaginationHelper.FormatRange(2, 10, 100);
    ...
    {
        // Act
        string result = PaginationHelper.FormatRange(1, 10, 50, "{0} to {1} (total: {2})");
    ...
    public void EncodeCursor_ShouldCreateBase64String()
    {
        ...
        // Act
        string encoded = PaginationHelper.EncodeCursor(cursorValue);
    ...
    public void DecodeCursor_ShouldRecoverOriginalValue()
    {
        // Arrange
        int original = 12345;
        string encoded = PaginationHelper.EncodeCursor(original);

        // Act
        int decoded = PaginationHelper.DecodeCursor<int>(encoded);
    ...
    {
        // Act
        int result = PaginationHelper.DecodeCursor<int>(null);
    ...
    {
        // Act
        string encoded = PaginationHelper.EncodeCompositeCursor(
            ("Id", 123),
            ("Name", "Test"));
    ...
    {
        // Act
        bool isValid = PaginationHelper.TryValidateParameters(1, 20, 100, out string? error);
    ...
    {
        // Act
        bool isValid = PaginationHelper.TryValidateParameters(0, 20, 100, out string? error);
