...
public class MessagePackCacheSerializer(
    MessagePackSerializerOptions? options = null,
    ILogger<MessagePackCacheSerializer>? logger = null) : ICacheSerializer
{
    private readonly MessagePackSerializerOptions _options = options ?? MessagePackSerializerOptions.Standard;
    private readonly ILogger<MessagePackCacheSerializer>? _logger = logger;
    ...
    public Task<byte[]> SerializeAsync<T>(T value, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            byte[] bytes = MessagePackSerializer.Serialize(value, _options);
