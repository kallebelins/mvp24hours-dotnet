...
public class InMemoryCacheInvalidationEventPublisher(ILogger<InMemoryCacheInvalidationEventPublisher>? logger = null) : ICacheInvalidationEventPublisher
{
    private readonly ConcurrentQueue<CacheInvalidationEvent> _events = new();
    private readonly ILogger<InMemoryCacheInvalidationEventPublisher>? _logger = logger;
