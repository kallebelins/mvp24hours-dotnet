...
public class InMemoryCacheSynchronizer(ILogger<InMemoryCacheSynchronizer>? logger = null) : ICacheSynchronizer
{
    private readonly ILogger<InMemoryCacheSynchronizer>? _logger = logger;
