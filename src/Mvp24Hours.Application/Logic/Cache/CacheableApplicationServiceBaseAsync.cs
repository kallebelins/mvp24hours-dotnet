    ...
    where TUoW : class, IUnitOfWorkAsync
{
    ...
    /// </summary>
    protected IQueryCacheProvider CacheProvider { get; }

    /// <summary>
    /// Gets the cache invalidator.
    /// </summary>
    protected ICacheInvalidator CacheInvalidator { get; }
        ...
        IValidator<TEntity>? validator = null)
    {
        ...
        CacheInvalidator = cacheInvalidator ?? throw new ArgumentNullException(nameof(cacheInvalidator));
    ...
    public virtual async Task<IBusinessResult<bool>> ListAnyAsync(CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKey(nameof(ListAnyAsync));
    ...
    public virtual async Task<IBusinessResult<int>> ListCountAsync(CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKey(nameof(ListCountAsync));
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
    ...
    public virtual async Task<IBusinessResult<IList<TEntity>>> ListAsync(IPagingCriteria? criteria, CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKey(nameof(ListAsync), criteria);
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
    ...
    public virtual async Task<IBusinessResult<bool>> GetByAnyAsync(Expression<Func<TEntity, bool>> clause, CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKeyFromExpression(nameof(GetByAnyAsync), clause);
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
    ...
    public virtual async Task<IBusinessResult<int>> GetByCountAsync(Expression<Func<TEntity, bool>> clause, CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKeyFromExpression(nameof(GetByCountAsync), clause);
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
    ...
    public virtual async Task<IBusinessResult<IList<TEntity>>> GetByAsync(Expression<Func<TEntity, bool>> clause, IPagingCriteria? criteria, CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKeyFromExpression(nameof(GetByAsync), clause, criteria);
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
    ...
    public virtual async Task<IBusinessResult<TEntity?>> GetByIdAsync(object id, IPagingCriteria? criteria, CancellationToken cancellationToken = default)
    {
        ...
        string cacheKey = GenerateCacheKey(nameof(GetByIdAsync), id, criteria);
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
        ...
        where TSpec : ISpecificationQuery<TEntity>
    {
        ...
        string cacheKey = GenerateCacheKey($"AnyBySpec_{specification.GetType().Name}", specification.GetHashCode());
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
        ...
        where TSpec : ISpecificationQuery<TEntity>
    {
        ...
        string cacheKey = GenerateCacheKey($"CountBySpec_{specification.GetType().Name}", specification.GetHashCode());
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
        ...
        where TSpec : ISpecificationQuery<TEntity>
    {
        ...
        string cacheKey = GenerateCacheKey($"GetBySpec_{specification.GetType().Name}", specification.GetHashCode());
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
        ...
        where TSpec : ISpecificationQuery<TEntity>
    {
        ...
        string cacheKey = GenerateCacheKey($"GetSingleBySpec_{specification.GetType().Name}", specification.GetHashCode());
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
            async () =>
            {
        ...
        where TSpec : ISpecificationQuery<TEntity>
    {
        ...
        string cacheKey = GenerateCacheKey($"GetFirstBySpec_{specification.GetType().Name}", specification.GetHashCode());
        return await CacheProvider.GetOrSetAsync(
            cacheKey,
            async () =>
            {
    ...
    public virtual async Task<IBusinessResult<int>> RemoveByIdAsync(object id, CancellationToken cancellationToken = default)
    {
        ...
        if (AutoInvalidateOnCommand && result.HasData() && result.GetDataValue() > 0)
        {
            await CacheInvalidator.InvalidateByIdAsync<TEntity>(id, cancellationToken);
            await InvalidateCacheAsync(cancellationToken);
        }
    ...
    {
        Type entityType = typeof(TEntity);
        string expressionHash = expression.ToString().GetHashCode().ToString("X8");
        string key = $"{entityType.Name}:{operation}:{expressionHash}";
    ...
    protected virtual async Task InvalidateCacheAsync(CancellationToken cancellationToken = default)
    {
        ...
        await CacheInvalidator.InvalidateEntityAsync<TEntity>(cancellationToken);
    }
