...
/// </remarks>
public class ExceptionToResultMapper(IOptions<ExceptionMappingOptions>? options = null) : IExceptionToResultMapper
{
    private readonly ExceptionMappingOptions _options = options?.Value ?? new ExceptionMappingOptions();
    private readonly Dictionary<Type, ExceptionMapping> _defaultMappings = BuildDefaultMappings();
