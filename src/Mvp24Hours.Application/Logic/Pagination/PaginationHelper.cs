...
public static class PaginationHelper
{
    ...
    public static PaginationMetadata FromCriteria(IPagingCriteria criteria, int totalCount)
    {
        ...
        int pageSize = criteria.Limit > 0 ? criteria.Limit : DefaultPageSize;
        int page = OffsetToPage(criteria.Offset, pageSize);
    ...
    {
        int start = GetStartIndex(page, pageSize, totalCount);
        int end = GetEndIndex(page, pageSize, totalCount);
    ...
    {
        string json = JsonSerializer.Serialize(cursorValue);
