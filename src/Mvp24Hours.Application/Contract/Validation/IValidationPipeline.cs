...
public class ValidationStepContext(ValidationOptions options, System.IServiceProvider? serviceProvider = null)
{
    /// <summary>
    /// Gets the validation options.
    /// </summary>
    public ValidationOptions Options { get; } = options ?? ValidationOptions.Default;
    ...
    /// </summary>
    public System.IServiceProvider? ServiceProvider { get; } = serviceProvider;
    ...
    {
        string childPath = string.IsNullOrEmpty(PropertyPath)
            ? propertyName
