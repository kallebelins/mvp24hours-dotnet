...
public static class PagedResultExtensions
{
    ...
    public static IPagedResult<T> ToPagedResult<T>(
        ...
        int totalCount)
    {
        IReadOnlyList<T> items = source as IReadOnlyList<T> ?? [.. source];
    ...
    public static IPagedResult<T> ToPagedResultInMemory<T>(
        ...
        int pageSize)
    {
        IList<T> allItems = source as IList<T> ?? [.. source];
        ...
        string pageSizeParam = "pageSize")
    {
        ...
        {
            return $"{baseUrl}{separator}{pageParam}={page}&{pageSizeParam}={source.PageSize}";
        }
