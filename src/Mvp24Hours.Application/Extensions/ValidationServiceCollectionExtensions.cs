...
public static class ValidationServiceCollectionExtensions
{
                ...
                foreach (Type @interface in interfaces)
                {
                    ...
                    services.TryAdd(new ServiceDescriptor(
                        ...
                        sp =>
                        {
                            ...
                            object? logger = sp.GetService(loggerType);
    ...
    public static IServiceCollection AddValidationServicesFromAssemblyContaining<T>(
        ...
        ServiceLifetime lifetime = ServiceLifetime.Scoped)
    {
        return services.AddValidationServices([typeof(T).Assembly], lifetime);
    }
    ...
    public static IServiceCollection AddDefaultValidationPipeline<T>(
        ...
        where T : class
    {
        return services.AddValidationPipeline<T>(builder => builder.AddStep(new NullCheckValidationStep<T>())
                   .UseFluentValidation()
                   .UseDataAnnotations()
                   .UseCascadeValidation(), lifetime);
    }
    ...
    public static IServiceCollection AddMvp24HoursValidationFromAssemblyContaining<T>(
        ...
        Action<ValidationServiceOptions>? configureOptions = null)
    {
        return services.AddMvp24HoursValidation([typeof(T).Assembly], configureOptions);
    }
