...
public sealed class PipelineContextAccessor : IPipelineContextAccessor
{
    ...
    /// </summary>
    private sealed class ContextScope(PipelineContextAccessor accessor, IPipelineContext? previousContext) : IDisposable
    {
        private readonly PipelineContextAccessor _accessor = accessor;
        private readonly IPipelineContext? _previousContext = previousContext;
