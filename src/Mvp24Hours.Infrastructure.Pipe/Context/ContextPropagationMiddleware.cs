...
public sealed class ContextPropagationMiddleware(
    IPipelineContextAccessor contextAccessor,
    ILogger<ContextPropagationMiddleware>? logger = null,
    ContextPropagationOptions? options = null) : IPipelineMiddleware
{
    ...
    private readonly ILogger<ContextPropagationMiddleware>? _logger = logger;
    private readonly ContextPropagationOptions _options = options ?? new ContextPropagationOptions();
