...
public sealed class SagaStepResult
{
    ...
    /// </summary>
    public static SagaStepResult Success(object? data = null)
    {
        return new()
        {
            IsSuccess = true,
    ...
    /// </summary>
    public static SagaStepResult Failure(string errorMessage, Exception? exception = null, bool skipCompensation = false)
    {
        return new()
        {
            IsSuccess = false,
    ...
    /// </summary>
    public static SagaStepResult Failure(Exception exception, bool skipCompensation = false)
    {
        return new()
        {
            IsSuccess = false,
