...
/// </remarks>
public class RateLimitingPipelineMiddleware(
    IRateLimiterProvider rateLimiterProvider,
    RateLimitingPipelineOptions? options = null,
    ILogger<RateLimitingPipelineMiddleware>? logger = null) : IPipelineMiddleware, IDisposable
{
    ...
    private readonly RateLimitingPipelineOptions _options = options ?? RateLimitingPipelineOptions.Default;
    private readonly ILogger<RateLimitingPipelineMiddleware>? _logger = logger;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string key = GetRateLimiterKey(message, rateLimitedOperation);
