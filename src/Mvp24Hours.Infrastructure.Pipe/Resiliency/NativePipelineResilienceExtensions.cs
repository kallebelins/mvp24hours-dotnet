...
public class NativePipelineResilienceMiddleware(
    NativePipelineResilienceOptions options,
    ILogger<NativePipelineResilienceMiddleware>? logger = null) : IPipelineMiddleware
{
    private readonly ResiliencePipeline _pipeline = BuildPipeline(options ?? new NativePipelineResilienceOptions());
    private readonly ILogger<NativePipelineResilienceMiddleware>? _logger = logger;
