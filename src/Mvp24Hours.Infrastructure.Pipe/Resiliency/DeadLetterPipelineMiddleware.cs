...
public class DeadLetterPipelineMiddleware(
    IDeadLetterStore deadLetterStore,
    DeadLetterOptions options,
    ILogger<DeadLetterPipelineMiddleware>? logger = null) : IPipelineMiddleware
{
    private readonly ILogger<DeadLetterPipelineMiddleware>? _logger = logger;
    ...
    private readonly DeadLetterOptions _options = options ?? throw new ArgumentNullException(nameof(options));
