...
public class PipelineAsync : PipelineBase, IPipelineAsync
{
    ...
    {
        provider = _provider;
        _logger = _provider?.GetService<ILogger<PipelineAsync>>();
        ...
        if (options != null)
        {
            ...
            ForceRollbackOnFalure = options.ForceRollbackOnFalure;
        }
    ...
    #region [ Get ]
    public List<IOperationAsync> GetOperations()
    {
        return operations;
    }

    public Dictionary<PipelineInterceptorType, List<IOperationAsync>> GetInterceptors()
    {
        return dictionaryInterceptors;
    }

    public List<KeyValuePair<Func<IPipelineMessage, bool>, IOperationAsync>> GetPreInterceptors()
    {
        return preCustomInterceptors;
    }

    public List<KeyValuePair<Func<IPipelineMessage, bool>, IOperationAsync>> GetPostInterceptors()
    {
    ...
    public IPipelineAsync Add(Action<IPipelineMessage> action, bool isRequired = false)
    {
        ...
        operations.Add(new OperationActionAsync(action, isRequired));
        return this;
    }
    ...
    public IPipelineAsync AddInterceptors(IOperationAsync operation, Func<IPipelineMessage, bool> condition, bool postOperation = true)
    {
        ...
        if (postOperation)
        {
            postCustomInterceptors.Add(new KeyValuePair<Func<IPipelineMessage, bool>, IOperationAsync>(condition, operation));
        }
        else
        {
            preCustomInterceptors.Add(new KeyValuePair<Func<IPipelineMessage, bool>, IOperationAsync>(condition, operation));
        }
        return this;
    }
    public IPipelineAsync AddInterceptors(Action<IPipelineMessage> action, Func<IPipelineMessage, bool> condition, bool postOperation = true)
    {
        ...
        if (postOperation)
        {
            postCustomInterceptors.Add(new KeyValuePair<Func<IPipelineMessage, bool>, IOperationAsync>(condition, new OperationActionAsync(action)));
        }
        else
        {
            preCustomInterceptors.Add(new KeyValuePair<Func<IPipelineMessage, bool>, IOperationAsync>(condition, new OperationActionAsync(action)));
        }
        return this;
    }
    public IPipelineAsync AddInterceptors(MvpEventHandler<IPipelineMessage, EventArgs> handler, PipelineInterceptorType pipelineInterceptor = PipelineInterceptorType.PostOperation)
    {
        if (handler == null)
        {
    ...
    public IPipelineAsync AddInterceptors(MvpEventHandler<IPipelineMessage, EventArgs> handler, Func<IPipelineMessage, bool> condition, bool postOperation = true)
    {
        if (handler == null)
        {
    ...
    public async Task ExecuteAsync(IPipelineMessage? input = null)
    {
        ...
        try
        {
            ...
            Message = await RunOperationsAsync(operations, Message);
        }
