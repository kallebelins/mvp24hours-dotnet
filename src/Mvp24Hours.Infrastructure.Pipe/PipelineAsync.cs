...
namespace Mvp24Hours.Infrastructure.Pipe
{
    ...
    public class PipelineAsync : PipelineBase, IPipelineAsync
    {
        ...
        public Dictionary<PipelineInterceptorType, List<MvpEventHandler<IPipelineMessage, EventArgs>>> GetEvents() => dictionaryEventInterceptors;
        public List<KeyValuePair<Func<IPipelineMessage, bool>, MvpEventHandler<IPipelineMessage, EventArgs>>> GetPreEvents() => preEventCustomInterceptors;
        public List<KeyValuePair<Func<IPipelineMessage, bool>, MvpEventHandler<IPipelineMessage, EventArgs>>> GetPostEvents() => postEventCustomInterceptors;
        #endregion
        ...
        public IPipelineAsync AddInterceptors(MvpEventHandler<IPipelineMessage, EventArgs> handler, Func<IPipelineMessage, bool> condition, bool postOperation = true)
        {
            ...
            if (postOperation)
            {
                this.postEventCustomInterceptors.Add(new KeyValuePair<Func<IPipelineMessage, bool>, MvpEventHandler<IPipelineMessage, EventArgs>>(condition, handler));
            }
            else
            {
                this.preEventCustomInterceptors.Add(new KeyValuePair<Func<IPipelineMessage, bool>, MvpEventHandler<IPipelineMessage, EventArgs>>(condition, handler));
            }
            return this;
        }
