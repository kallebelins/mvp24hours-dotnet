...
public class PipelineHealthCheck(
    ...
    PipelineHealthCheckOptions? options = null) : IHealthCheck
{
    private readonly IPipelineMetrics _metrics = metrics ?? throw new ArgumentNullException(nameof(metrics));
    private readonly PipelineHealthCheckOptions _options = options ?? new PipelineHealthCheckOptions();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string description = string.Join("; ", issues);
...
public class PipelineHealthMonitor(
    IPipelineMetrics metrics,
    PipelineHealthCheckOptions? options = null) : IPipelineHealthMonitor
{
    private readonly IPipelineMetrics _metrics = metrics ?? throw new ArgumentNullException(nameof(metrics));
    private readonly PipelineHealthCheckOptions _options = options ?? new PipelineHealthCheckOptions();
