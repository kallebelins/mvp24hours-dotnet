...
/// </summary>
/// <remarks>
/// Event IDs: 2000-2999 (Pipeline module range). Each message has a unique EventId.
/// </remarks>
public static partial class PipelineLoggerMessages
{
    ...
    public const int PipelineBreakOnFailureEventId = PipelineEventIdBase + 4;

    // Operation Lifecycle
    public const int OperationStartedEventId = PipelineEventIdBase + 5;
    public const int OperationCompletedEventId = PipelineEventIdBase + 6;
    public const int OperationFailedEventId = PipelineEventIdBase + 7;
    public const int OperationSkippedEventId = PipelineEventIdBase + 8;
    public const int SlowOperationEventId = PipelineEventIdBase + 9;

    // Resiliency
    public const int RetryTriggeredEventId = PipelineEventIdBase + 10;
    public const int RetryExhaustedEventId = PipelineEventIdBase + 11;
    public const int CircuitBreakerOpenedEventId = PipelineEventIdBase + 12;
    public const int CircuitBreakerClosedEventId = PipelineEventIdBase + 13;
    public const int CircuitBreakerHalfOpenEventId = PipelineEventIdBase + 14;

    // Validation
    public const int ValidationFailedEventId = PipelineEventIdBase + 15;
    public const int ValidationPassedEventId = PipelineEventIdBase + 16;

    // Context
    public const int ContextCreatedEventId = PipelineEventIdBase + 17;
    public const int ContextDataAddedEventId = PipelineEventIdBase + 18;
    public const int StateSnapshotSavedEventId = PipelineEventIdBase + 19;

    // Fork/Join
    public const int ForkedToBranchesEventId = PipelineEventIdBase + 20;
    public const int JoinedBranchesEventId = PipelineEventIdBase + 21;
    public const int BranchCompletedEventId = PipelineEventIdBase + 22;

    // Checkpoint/Resume
    public const int CheckpointSavedEventId = PipelineEventIdBase + 23;
    public const int ResumingFromCheckpointEventId = PipelineEventIdBase + 24;
    public const int CheckpointCleanedUpEventId = PipelineEventIdBase + 25;

    // Saga
    public const int SagaStartedEventId = PipelineEventIdBase + 26;
    public const int SagaCompletedEventId = PipelineEventIdBase + 27;
    public const int SagaCompensatingEventId = PipelineEventIdBase + 28;
    public const int SagaFailedEventId = PipelineEventIdBase + 29;
    public const int SagaStepCompensatedEventId = PipelineEventIdBase + 30;

    // Caching
    public const int CacheHitEventId = PipelineEventIdBase + 31;
    public const int CacheMissEventId = PipelineEventIdBase + 32;
    public const int CacheSetEventId = PipelineEventIdBase + 33;
    ...
    [LoggerMessage(
        EventId = PipelineBreakOnFailureEventId,
    ...
    [LoggerMessage(
        EventId = CircuitBreakerHalfOpenEventId,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = ContextDataAddedEventId,
    ...
    [LoggerMessage(
        EventId = StateSnapshotSavedEventId,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = ForkedToBranchesEventId,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = BranchCompletedEventId,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = CheckpointSavedEventId,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = ResumingFromCheckpointEventId,
        Level = LogLevel.Information,
    ...
    [LoggerMessage(
        EventId = CheckpointCleanedUpEventId,
        Level = LogLevel.Debug,
    ...
    [LoggerMessage(
        EventId = SagaCompensatingEventId,
        Level = LogLevel.Warning,
    ...
    [LoggerMessage(
        EventId = SagaStepCompensatedEventId,
        Level = LogLevel.Debug,
