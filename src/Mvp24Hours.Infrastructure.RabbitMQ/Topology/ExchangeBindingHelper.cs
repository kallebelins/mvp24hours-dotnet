...
public static class ExchangeBindingHelper
{
        ...
        bool durable = true)
    {
        ...
        foreach (string childExchange in childExchanges)
        {
            channel.ExchangeDeclare(
            ...
            string routingKey = exchangeType == MvpRabbitMQExchangeType.topic ? "#" : "";
        ...
        bool durable = true)
    {
        ...
        foreach (string destExchange in destinationExchanges)
        {
        ...
        bool durable = true)
    {
        ...
        foreach (string sourceExchange in sourceExchanges)
        {
            // Declare source
            channel.ExchangeDeclare(
                exchange: sourceExchange,
        ...
        bool durable = true)
    {
        ...
        {
            string destExchange = rule.Key;
            string routingKeyPattern = rule.Value;
