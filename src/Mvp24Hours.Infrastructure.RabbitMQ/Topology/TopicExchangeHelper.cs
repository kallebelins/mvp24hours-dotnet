...
public static class TopicExchangeHelper
{
        ...
        IEnumerable<string> routingKeyPatterns)
    {
        ...
        foreach (string pattern in routingKeyPatterns)
        {
    ...
    {
        string wildcards = string.Join(".", System.Linq.Enumerable.Repeat(SingleWordWildcard, levels));
    ...
    public static bool IsValidPattern(string pattern)
    {
        ...
        for (int i = 0; i < parts.Length; i++)
        {
            ...
            if (part is not SingleWordWildcard and not MultiWordWildcard)
            {
