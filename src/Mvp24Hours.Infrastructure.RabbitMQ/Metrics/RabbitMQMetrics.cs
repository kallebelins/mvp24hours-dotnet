...
public class RabbitMQMetrics : IRabbitMQMetrics
{
    ...
    {
        Interlocked.Increment(ref _messagesAcked);
    }

    /// <inheritdoc />
    public void IncrementMessagesNacked()
    {
        Interlocked.Increment(ref _messagesNacked);
    }
    ...
    {
        Interlocked.Increment(ref _messagesRedelivered);
    }

    /// <inheritdoc />
    public void IncrementPublisherConfirms()
    {
        Interlocked.Increment(ref _publisherConfirms);
    }

    /// <inheritdoc />
    public void IncrementPublisherNacks()
    {
        Interlocked.Increment(ref _publisherNacks);
    }
    ...
    {
        Interlocked.Increment(ref _channelCreations);
    }

    /// <inheritdoc />
    public void IncrementDuplicateMessagesSkipped()
    {
        Interlocked.Increment(ref _duplicateMessagesSkipped);
    }
