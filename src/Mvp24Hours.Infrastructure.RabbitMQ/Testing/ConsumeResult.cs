...
public class ConsumeResult
{
    ...
    /// </summary>
    public static ConsumeResult Success(string messageId, TimeSpan duration)
    {
        return new()
        {
            IsSuccess = true,
    ...
    /// </summary>
    public static ConsumeResult Failure(string messageId, Exception exception, TimeSpan duration, bool requeued = false)
    {
        return new()
        {
            IsSuccess = false,
    ...
    /// </summary>
    public static ConsumeResult Timeout(string messageId, TimeSpan duration)
    {
        return new()
        {
            IsSuccess = false,
    ...
    /// </summary>
    public static ConsumeResult Cancelled(string messageId, TimeSpan duration)
    {
        return new()
        {
            IsSuccess = false,
