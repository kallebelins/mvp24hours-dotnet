...
/// </remarks>
public class PublishedMessage<TMessage>(PublishedMessage inner, TMessage message) : IPublishedMessage<TMessage> where TMessage : class
{
    private readonly PublishedMessage _inner = inner ?? throw new ArgumentNullException(nameof(inner));
