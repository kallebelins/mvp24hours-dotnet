...
/// </remarks>
public class ConsumedMessage<TMessage>(ConsumedMessage inner, TMessage message, IConsumeContext<TMessage> context) : IConsumedMessage<TMessage> where TMessage : class
{
    private readonly ConsumedMessage _inner = inner ?? throw new ArgumentNullException(nameof(inner));

    /// <inheritdoc />
    public TMessage Message { get; } = message ?? throw new ArgumentNullException(nameof(message));

    /// <inheritdoc />
    public IConsumeContext<TMessage> Context { get; } = context ?? throw new ArgumentNullException(nameof(context));
