...
public class BatchMessageResult : IBatchMessageResult
{
    ...
    {
        return new(deliveryTag, success: true, requeue: false, errorMessage: null);
    }
    ...
    {
        return new(deliveryTag, success: false, requeue: requeue, errorMessage: errorMessage);
    }
    ...
    {
        return Nack(item.DeliveryTag, requeue, errorMessage);
    }
    ...
    {
        return context.Messages.Select(m => Ack(m.DeliveryTag));
    }
    ...
    public static IEnumerable<IBatchMessageResult> NackAll<TMessage>(
        ...
        string? errorMessage = null) where TMessage : class
    {
        return context.Messages.Select(m => Nack(m.DeliveryTag, requeue, errorMessage));
    }
}
...
public static class BatchMessageResultExtensions
{
    ...
    {
        return results.Where(r => !r.Success && r.Requeue);
    }
