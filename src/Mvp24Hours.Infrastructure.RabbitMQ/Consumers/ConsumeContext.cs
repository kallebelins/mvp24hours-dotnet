...
public class ConsumeContext<TMessage> : IConsumeContext<TMessage> where TMessage : class
{
    ...
    {
        string? replyTo = _deliverEventArgs.BasicProperties?.ReplyTo;
    ...
    {
        Microsoft.Extensions.DependencyInjection.IServiceScope scope = ServiceProvider.CreateScope();
        return new ServiceScopeWrapper(scope);
    }

    private class ServiceScopeWrapper(Microsoft.Extensions.DependencyInjection.IServiceScope scope) : Core.Contract.IServiceScope
    {
        private readonly Microsoft.Extensions.DependencyInjection.IServiceScope _scope = scope;
