...
public class RabbitMQStructuredLogger(ILogger<RabbitMQStructuredLogger> logger) : IRabbitMQStructuredLogger
{
    private readonly ILogger<RabbitMQStructuredLogger> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
