...
/// </remarks>
public class RateLimitingConsumeFilter(
    IRateLimiterProvider rateLimiterProvider,
    RateLimitingConsumeFilterOptions? options = null,
    ILogger<RateLimitingConsumeFilter>? logger = null) : IConsumeFilter
{
    ...
    private readonly RateLimitingConsumeFilterOptions _options = options ?? RateLimitingConsumeFilterOptions.Default;
    private readonly ILogger<RateLimitingConsumeFilter>? _logger = logger;
