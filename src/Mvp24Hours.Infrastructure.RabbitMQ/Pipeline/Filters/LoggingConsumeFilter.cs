...
public class LoggingConsumeFilter(ILogger<LoggingConsumeFilter>? logger = null) : IConsumeFilter
{
    private readonly ILogger<LoggingConsumeFilter>? _logger = logger;
        ...
        CancellationToken cancellationToken = default) where TMessage : class
    {
        ...
        string queueName = context.QueueName;
