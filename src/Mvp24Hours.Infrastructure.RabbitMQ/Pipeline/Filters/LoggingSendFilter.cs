...
public class LoggingSendFilter(ILogger<LoggingSendFilter>? logger = null) : ISendFilter
{
    private readonly ILogger<LoggingSendFilter>? _logger = logger;
        ...
        CancellationToken cancellationToken = default) where TMessage : class
    {
        ...
        string destination = context.DestinationQueue;
