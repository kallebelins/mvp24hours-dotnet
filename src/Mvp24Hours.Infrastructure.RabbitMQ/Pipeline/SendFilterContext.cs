...
namespace Mvp24Hours.Infrastructure.RabbitMQ.Pipeline
{
    ...
    public class SendFilterContext<TMessage> : ISendFilterContext<TMessage> where TMessage : class
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            DestinationQueue = destinationQueue ?? throw new ArgumentNullException(nameof(destinationQueue));
