...
public class EmailQueueProcessor(
    ...
    ILogger<EmailQueueProcessor>? logger = null) : BackgroundService
{
    private readonly IEmailQueue _emailQueue = emailQueue ?? throw new ArgumentNullException(nameof(emailQueue));
    private readonly IEmailService _emailService = emailService ?? throw new ArgumentNullException(nameof(emailService));
    private readonly ILogger<EmailQueueProcessor>? _logger = logger;
    private readonly EmailQueueProcessorOptions _options = options?.Value ?? throw new ArgumentNullException(nameof(options));
    ...
    {
        string queueItemId = item.QueueItemId;
