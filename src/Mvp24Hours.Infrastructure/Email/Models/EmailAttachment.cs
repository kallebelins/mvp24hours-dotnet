...
public class EmailAttachment : IEmailAttachment
{
    ...
    public EmailAttachment(string fileName, Stream contentStream, string contentType, bool disposeStream = false)
    {
        ...
        FileName = fileName;
        _contentStream = contentStream ?? throw new ArgumentNullException(nameof(contentStream), "Content stream cannot be null.");
        ContentType = contentType;
    ...
    public byte[]? Content
    {
        get
        {
            ...
            if (_contentStream != null)
            {
                ...
                {
                    long originalPosition = _contentStream.Position;
