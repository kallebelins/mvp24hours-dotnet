...
public class ScribanEmailTemplateRenderer(TemplateOptions? options = null) : IEmailTemplateRenderer
{
    private readonly TemplateOptions _options = options ?? new TemplateOptions();
