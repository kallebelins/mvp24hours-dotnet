...
public abstract class BaseDistributedLockProvider(DistributedLockMetrics? metrics = null) : IDistributedLock
{
    private readonly DistributedLockMetrics? _metrics = metrics;
