...
public class PostgreSqlDistributedLockProvider : BaseDistributedLockProvider
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            long lockIdInt = GetLockIdFromResource(resource);
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            long count = Convert.ToInt64(await command.ExecuteScalarAsync(cancellationToken) ?? 0L);
            return count > 0;
        }
        catch (Exception ex)
        {
    ...
    private class PostgreSqlLockHandle(
    ...
    {
        private readonly PostgreSqlDistributedLockProvider _provider = provider;
