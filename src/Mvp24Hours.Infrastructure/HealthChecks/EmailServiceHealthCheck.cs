    ...
    ILogger<EmailServiceHealthCheck> logger) : IHealthCheck
{
    ...
    private readonly EmailServiceHealthCheckOptions _options = options ?? new EmailServiceHealthCheckOptions();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (_options.SendTestEmail)
            {
                ...
                {
                    To = [_options.TestEmailRecipient ?? "health-check@example.com"],
...
public sealed class EmailServiceHealthCheckOptions
{
    ...
    /// </summary>
    public IEnumerable<string> Tags { get; set; } = ["email", "email-service", "ready"];
}
