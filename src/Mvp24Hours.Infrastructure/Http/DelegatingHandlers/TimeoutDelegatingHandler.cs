...
public class TimeoutDelegatingHandler(
    ILogger<TimeoutDelegatingHandler> logger,
    TimeSpan defaultTimeout,
    bool enabled = true) : DelegatingHandler
{
    private readonly ILogger<TimeoutDelegatingHandler> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
    private readonly TimeSpan _defaultTimeout = defaultTimeout;
