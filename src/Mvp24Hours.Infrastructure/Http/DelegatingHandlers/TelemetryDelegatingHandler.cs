...
public class TelemetryDelegatingHandler(
    ILogger<TelemetryDelegatingHandler>? logger,
    TelemetryHandlerOptions options) : DelegatingHandler
{
    private readonly ILogger<TelemetryDelegatingHandler>? _logger = logger;
    private readonly TelemetryHandlerOptions _options = options ?? new TelemetryHandlerOptions();
