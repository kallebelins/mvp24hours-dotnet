...
public class AuthenticationDelegatingHandler : DelegatingHandler
{
    ...
    private void ApplyApiKeyAuthentication(HttpRequestMessage request)
    {
        ...
        string headerName = string.IsNullOrWhiteSpace(_options.ApiKeyHeaderName)
            ? "X-API-Key"
        ...
        else if (_options.ApiKeyLocation == ApiKeyLocation.QueryString)
        {
            ...
            string separator = string.IsNullOrWhiteSpace(uri.Query) ? "?" : "&";
            string paramName = string.IsNullOrWhiteSpace(_options.ApiKeyQueryParamName)
                ? "api_key"
    ...
    private void ApplyBasicAuthentication(HttpRequestMessage request)
    {
        ...
        string credentials = $"{_options.Username}:{_options.Password ?? string.Empty}";
