...
/// </remarks>
public class MessagePackHttpClientSerializer(MessagePackSerializerOptions options) : IHttpContentSerializer
{
    ...
    public HttpContent Serialize(object? value)
    {
        ...
        try
        {
            byte[] bytes = MessagePackSerializer.Serialize(value.GetType(), value, _options);
