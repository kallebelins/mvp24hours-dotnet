...
public class HttpClientBuilder
{
    ...
    /// </summary>
    public static HttpClientBuilder Create(string name)
    {
        return new HttpClientBuilder().WithName(name);
    }
    ...
    /// </summary>
    public static implicit operator HttpClientOptions(HttpClientBuilder builder)
    {
