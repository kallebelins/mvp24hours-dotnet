...
public static class LoggingExtensions
{
        ...
        params object[] args)
    {
        ...
        object[] maskedArgs = MaskArguments(args, sensitiveKeys);
        logger.LogInformation(message, maskedArgs);
    }
    ...
    private static object[] MaskArguments(object[] args, IEnumerable<string> sensitiveKeys)
    {
        ...
        _ = new HashSet<string>(sensitiveKeys, StringComparer.OrdinalIgnoreCase);
        object[] maskedArgs = new object[args.Length];
    ...
    private static bool IsPassword(string value)
    {
        ...
        return value.Length is >= 8 and <= 128;
    }
    ...
    private static bool IsCreditCard(string value)
    {
        ...
        int digits = new System.Text.RegularExpressions.Regex(@"\d").Matches(value).Count;
        return digits is >= 13 and <= 19;
    }
