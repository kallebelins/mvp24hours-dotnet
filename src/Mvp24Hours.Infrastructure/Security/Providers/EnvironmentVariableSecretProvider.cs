...
public class EnvironmentVariableSecretProvider(EnvironmentVariableOptions options) : ISecretProvider
{
    private readonly EnvironmentVariableOptions _options = options ?? throw new ArgumentNullException(nameof(options));
    ...
    public Task<string?> GetSecretAsync(string secretName, CancellationToken cancellationToken = default)
    {
        ...
        string variableName = GetVariableName(secretName);
        string? value = Environment.GetEnvironmentVariable(variableName, _options.Target);
    ...
    {
        string variableName = secretName;
