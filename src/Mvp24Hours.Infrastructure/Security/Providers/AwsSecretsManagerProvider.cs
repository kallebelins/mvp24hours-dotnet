...
public class AwsSecretsManagerProvider : ISecretProvider
{
    ...
    public async Task<string?> GetSecretAsync(string secretName, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            string fullSecretName = GetFullSecretName(secretName);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IEnumerable<Task<KeyValuePair<string, string?>>> tasks = secretNames.Select(async name =>
        {
            ...
            string? value = await GetSecretAsync(name, cancellationToken);
    ...
    public async Task<bool> SecretExistsAsync(string secretName, CancellationToken cancellationToken = default)
    {
        ...
        string? value = await GetSecretAsync(secretName, cancellationToken);
        return value != null;
    }
