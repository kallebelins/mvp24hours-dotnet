    ...
    IEnumerable<object?>? scopes = null)
{
    ...
    /// </summary>
    public IReadOnlyList<object?> Scopes { get; } = scopes?.ToList().AsReadOnly() ?? (IReadOnlyList<object?>)[];
...
public class FakeLogger(string? categoryName = null) : ILogger
{
    ...
    /// </summary>
    public string CategoryName { get; } = categoryName ?? "FakeLogger";
