...
public sealed class InMemoryLoggerProvider : ILoggerProvider
{
    ...
    /// </summary>
    private sealed class InMemoryCategoryLogger(string categoryName, InMemoryLoggerProvider provider) : ILogger
    {
...
/// </remarks>
public sealed class CategorizedLogEntry(
    string categoryName,
    LogLevel logLevel,
    EventId eventId,
    string message,
    Exception? exception,
    object? state,
    IEnumerable<object?>? scopes = null) : LogEntry(logLevel, eventId, message, exception, state, scopes)
{
    /// <summary>
    ...
    {
        string exceptionPart = Exception != null ? $" [Exception: {Exception.Message}]" : "";
