...
public class NativeResiliencePipeline<TResult> : INativeResiliencePipeline<TResult>
{
        ...
        ILogger? logger = null)
    {
        ...
        _logger = logger;
        UnderlyingPipeline = BuildPipeline(options);
    }
    ...
    {
        return UnderlyingPipeline.ExecuteAsync(operation, cancellationToken);
    }
    ...
    public async Task<TResult> ExecuteTaskAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await UnderlyingPipeline.ExecuteAsync(
    ...
    /// </summary>
    public ResiliencePipeline<TResult> UnderlyingPipeline { get; }
    ...
    {
        return NativeResiliencePredicates.ConvertBackoffType(backoffType);
    }
}
...
public class NativeResiliencePipeline : INativeResiliencePipeline
{
    ...
    public async Task ExecuteTaskAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        await UnderlyingPipeline.ExecuteAsync(
            async ct => await operation(ct),
            cancellationToken);
    }
    ...
    /// Gets the underlying Polly ResiliencePipeline for advanced scenarios.
    /// </summary>
    public ResiliencePipeline UnderlyingPipeline { get; }
