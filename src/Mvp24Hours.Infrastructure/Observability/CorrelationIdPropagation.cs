...
public static class CorrelationIdPropagation
{
    ...
    public static string GetCorrelationId()
    {
        ...
        if (activity != null)
        {
            ...
            string? correlationId = activity.GetBaggageItem(CorrelationIdBaggageKey);
    ...
    public static string EnsureCorrelationId()
    {
        ...
        if (activity != null)
        {
            string? existing = activity.GetBaggageItem(CorrelationIdBaggageKey);
        ...
        string? correlationId = null)
    {
        ...
        string id = correlationId ?? GetCorrelationId();
