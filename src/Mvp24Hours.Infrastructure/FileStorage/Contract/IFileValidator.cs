    ...
    Stream? contentStream = null)
{
    ...
    /// </summary>
    public string FileName { get; } = fileName ?? throw new System.ArgumentNullException(nameof(fileName));
    ...
    /// </summary>
    public string ContentType { get; } = contentType ?? throw new System.ArgumentNullException(nameof(contentType));
    ...
    /// </remarks>
    public string FileExtension { get; } = fileExtension ?? throw new System.ArgumentNullException(nameof(fileExtension));
...
public class ValidationResult
{
    ...
    public static ValidationResult Failed(string errorMessage)
    {
        ...
        return new ValidationResult(false, errors: [errorMessage]);
    }
}
