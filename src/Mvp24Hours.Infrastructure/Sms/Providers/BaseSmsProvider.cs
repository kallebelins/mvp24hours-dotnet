...
public abstract class BaseSmsProvider(SmsOptions options) : ISmsService
{
    /// <summary>
    /// Gets the SMS options.
    /// </summary>
    protected SmsOptions Options { get; } = options ?? throw new ArgumentNullException(nameof(options));
