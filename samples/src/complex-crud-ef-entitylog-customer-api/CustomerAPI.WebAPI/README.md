...
| --- | --- | --- | --- |
| `ConnectionStrings:EFDBContext` | Yes | SQL Server database containing audit columns | `Server=localhost,1433;Database=MyTestLogDb;User Id=sa;Password=<secret>;TrustServerCertificate=True` |
