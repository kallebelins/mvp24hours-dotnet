...
namespace CustomerAPI.Application.Extensions;

/// <summary>
/// Cancelable Dapper paging helpers for SQL Server reads.
/// </summary>
public static class DapperExtensions
{
        ...
        where T : class
    {
        ...
        SqlBuilder.Template sqlCount = sqlCountBuilder.AddTemplate($"select count(0) from {typeof(T).Name} /**where**/");
...
#pragma warning disable S125 // Sections of code should not be commented out
        ...
        /* SqlServer */
        SqlBuilder.Template sqlQuery = sqlQueryBuilder.AddTemplate($"select * from {typeof(T).Name} /**where**/ /**orderby**/ offset @offset rows fetch next @limit rows only");
#pragma warning restore S125 // Sections of code should not be commented out
        ...
        var queryCommand = new CommandDefinition(
            ...
            sqlQuery.Parameters,
            cancellationToken: cancellationToken);
        IEnumerable<T> result = await connection.QueryAsync<T>(queryCommand);
