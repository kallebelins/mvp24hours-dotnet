...
| --- | --- | --- | --- |
| `ConnectionStrings:EFDBContext` | Yes | SQL Server database updated by consumers | `Server=localhost,1433;Database=MyTestDbRabbitMQ;User Id=sa;Password=<secret>;TrustServerCertificate=True` |
